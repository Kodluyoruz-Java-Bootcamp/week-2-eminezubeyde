...
public class User {
	...
	List<Address> searchedAddresses;
	...
	public void addFavoriRealty(Realty favori){
		if(this.favoriteRealtyList==null){
			this.favoriteRealtyList=new ArrayList<>();
		}
		this.favoriteRealtyList.add(favori);
	}

	public void addSearchedRealtyForAddress(Address address){
		if(this.searchedAddresses==null){
			this.searchedAddresses=new ArrayList<>();
		}
		this.searchedAddresses.add(address);
	}
	...
	public List<Address> getSearchedAddresses() {
		return searchedAddresses;
	}

	public void setSearchedAddresses(List<Address> searchedAddresses) {
